...
<span className='flex items-center'>
    <div className='p-2 bg-red-500 text-white shadow-lg border border-gray-700/50 rounded-sm'>Below Range</div>
    <div className='p-2 bg-orange-500 text-white shadow-lg border border-gray-700/50 rounded-sm'>Above Range</div>
    <div className='p-2 bg-yellow-500 text-white shadow-lg border border-gray-700/50 rounded-sm'>Present</div>
